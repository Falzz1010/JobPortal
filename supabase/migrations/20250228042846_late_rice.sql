/*
  ...
  1. Changes
    - Fix foreign key constraint for jobs table
    - Add missing columns to profiles and companies tables
    - Update RLS policies for jobs table to use correct company relationship
    - Fix application policies to use proper company-job relationship
*/
